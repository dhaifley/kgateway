	...
	s.TestInstallation.Assertions.AssertEventualCurlResponse(
		...
		&testmatchers.HttpResponse{
			...
			Body: gomega.And(
				...
				gomega.MatchRegexp(`kgateway_resources_status_syncs_started_total\{gateway=\"gw2\",namespace=\"default\",resource=\"HTTPRoute\"} [2-3]`),
				gomega.MatchRegexp(`kgateway_resources_status_syncs_started_total\{gateway=\"gw2\",namespace=\"default\",resource=\"HTTPListenerPolicy\"} [1-2]`),
